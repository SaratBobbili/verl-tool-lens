...
def run_hrl_ppo(config) -> None:
    ...
    if (
        ...
        runner = HRLTaskRunner.options(runtime_env={"nsight": nsight_options}).remote()
    else:
...
class HRLTaskRunner:
    """Ray entry that mirrors PPO TaskRunner but uses HRL rollouts."""
