...
from verl.workers.config import FSDPCriticConfig, FSDPTeacherConfig, FSDPEngineConfig, HFModelConfig, RolloutConfig
...
class TeacherWorker(Worker, DistProfilerExtension):
    ...
    def init_model(self):
        ...
        from verl.workers.teacher import DataParallelTeacher
    ...
    def load_checkpoint(self, local_path, hdfs_path=None, del_local_after_load=True):
        ...
        if self._is_offload_optimizer:
            offload_fsdp_optimizer(self.teacher_optimizer)
