...
def test_critic_engine(strategy):
	...
	# This will request process groups with 1 GPU and 10 CPUs. The number inside process_on_nodes is the number of these groups
	# to request. Therefore, make sure the number is not larger than the number of available GPUs on your node
	resource_pool = RayResourcePool(process_on_nodes=[4])
